...
el.width= return window.screen.width*window.devicePixelRatio;
);
}
if(window==NULL)
return false;
...
/*:64*/
#line 1240 "weaver-window.tex"

/*65:*/
#line 1424 "weaver-window.tex"
