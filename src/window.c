...
dummy_window.style= CS_HREDRAW|CS_VREDRAW|CS_OWNDC;
ret= RegisterClass(&window_class);
if(ret==0){
#if defined(W_DEBUG_WINDOW)
...
if(!wglChoosePixelFormatARB(device_context,real_pixel_format,NULL,1,
&pixel_format_index,
