...
a confirmação de que a operação foi bem-sucedida lendo os próxios
eventos com o \monoespaco{XNextEvent}. Em seguida, atualizamos o
tamanho da tela de desenho OpenGL e executamos a função personalizada
escolhida pelo usuário relacionada ao redimencionamento da janela,
caso ela exista.
