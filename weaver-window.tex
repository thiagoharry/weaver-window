...
Em seguida, deixamos a janela em tela-cheia se esta for a configuração padrão:
...
obtiveros como resultado \monespaco{QUNS\_BUSY}:
...
A função acima requer o seguinte cabeçalho:
