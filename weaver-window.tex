...
\subsubsecao{2.3.2. Configurando OpenGL no Web Assembly}
...
Para nós, um teclado será representado pela seguinte estrutura de
dados:
...
de \monoespaco{keyboard.key[W\_ENTER]} sem ter que saber qual o código
