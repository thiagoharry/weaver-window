...
2. Obemos qual o número de identificação da tela principal (quando há
mais de um monitor).

3. Lemos a resolução da tela com a função que definimos na seção 2.1.
...
int screen;  // Identificação da tela padrão
/* Passo 0: */
XInitThreads();
/* Passo 1: */
display = XOpenDisplay(NULL);
