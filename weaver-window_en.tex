...
Next we let the window be in fullscreen mode if this is the current
configuration:
...
\subsubsection{2.7.1. Checking Fullscreen Mode on X11}
...
as result \monespaco{QUNS\_BUSY}:
...
The above function requires the following header:
