...
depending on the graphical environment where it is being executed. But
before this we will add code ro check if we already do not have an
active connection with the X server.
