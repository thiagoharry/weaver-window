...
The functions can be loaded using the
function \monoespaco{wglGetProcAddress}. For example, to use the
function \monoespaco{glCreateShader}, first we declare it here:
...
And then we load the function using:
