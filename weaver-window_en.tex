...
The function that reads pixels in the color buffer in our framebuffer
and can get screenshots is:
...
We also need the following macros to choose the pixel format and how
