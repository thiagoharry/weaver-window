...
context: \monoespaco{wglCreateContextAttribsARB}. Using this function
...
This is the external declaration that goes
to \monoespaco{window.h}. The real declaration is positioned
at \monoespaco{window.c} as a global variable:
...
Now we can finally configure the real pixel format for our window and
