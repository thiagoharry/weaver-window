...
if(event.type == ButtonPress){
  ...
  for(i = 0; i < 4; i ++){
    if(pressed_buttons[i].button == button) // Already being pressed
      break;
    if(pressed_buttons[i].button == 0){ // The pressing is beginning now
...
reeased. Then, we remove suchbutton from the list of pressed buttons
...
if(event.type == ButonRelease){
  ...
  for(i = 0; i < 4; i ++){ // Removing from pressed keys
  ...
  for(i = 0; i < 4; i ++){ // Adding to released keys:
