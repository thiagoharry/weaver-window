...
2. We get the number that identifies the default screen (when we have
more than one screen).

3. We read the resolution using the function defined on section 2.1.
