...
2.1.2. Getting Screen Resolution on Web Assembly \indice{06}
...
2.2.2. Creating a Window on Web Assembly \indice{10}

2.2.3. Creating a Window on (Microsoft) Windows \indice{13}

2.2.4. Defining the  Window Creation Function for All Environments \indice{15}
...
2.3.3. Configuring OpenGL on Windows \indice{18}
...
2.7. Checking Fullscreen Mode \indice{47}
...
2.8. Changing Between Fullscreen and Windowed Mode \indice{48}
...
3.4. Additional Input Functions \indice{73}
...
HTML canvas should have the same size than the screen, except if
macro \monoespaco{W\_WINDOW\_NO\_FULLSCREEN} is defined and if
macros \monoespaco{W\_WINDOW\_RESOLUTION\_X}
