...
\def@({%
        \lineskip=0pt\parskip=0pt(P)%
        @global@catcode`_=11\linha\espaco{1mm}\noindent\negrito{Arquivo:} \apar&}
\def\apar&#1@>#2{%
  \monoespaco{#1}%
  \if#2+
    \negrito{(continuação)}%
...
\def\fimsh&{@gdef@sh&{}@everypar{}@catcode`_=8@catcode`0=12@catcode`1=12%
  ...
  @gdef|{@gdef|{@fimsh&@alinhanormal&@catcode`\\=0@gdef@cm&{0}@gdef@c&{0} }%
  @ifvmode@indent@fi@alinhaverbatim&@gdef@c&{1}@catcode`\\=12@gdef@cm&{1}@iniciosh&}@twelve&@parskip=0pt plus 1pt@lineskip=1pt}
